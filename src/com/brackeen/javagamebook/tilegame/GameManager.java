    ...
    */ 
        ...
        long elapsedTime)
    {
        ...
        if(creature instanceof Bullet){
        	...
        	Beenshotted((Bullet)creature, (Player)map.getPlayer());
